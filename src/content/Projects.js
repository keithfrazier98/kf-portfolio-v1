      ...
      <div className="row justify-content-center">
        <div className="card cardDiv">
          ...
          <div className="card-body">
            <h3 className="card-title projectsH3">Periodic Tables</h3>
            <h5
            ...
            <div className="cardLinks btn-group" role="group">
              <a
                ...
                href="https://periodic-tables-frontend-three.vercel.app/dashboard"
                target="_blank"
              >
                live{" "}
                <svg
              ...
              <a
                ...
                href="https://github.com/keithfrazier98/periodic-tables-monorepo"
                target="_blank"
              >
                GitHub{" "}
                <svg
        ...
        <div className="card cardDiv">
          ...
          />
          <div className="card-body">
            <h3 className="card-title projectsH3">GrubDash</h3>
            <h5
              class="card-subtitle mb-2 text-muted"
              style={{ fontSize: "1rem" }}
            >
            ...
            <div className="cardLinks btn-group" role="group">
              <a
                className="btn btn-primary"
                href="https://starter-grub-dash-front-end-fksvwtozs-keithfrazier98.vercel.app/"
                target="_blank"
              >
                Live{" "}
                <svg
              ...
              <a
                className="btn btn-secondary"
                href="https://github.com/keithfrazier98/grubDash-project"
                target="_blank"
              >
                GitHub{" "}
                <svg
